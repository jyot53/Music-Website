                ...
                <div class="jumbotron col-sm-6 offset-sm-3">
                    ...
                    <form method="post" action="PaytmKit/pgRedirect.php">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input id="planNmae" class="form-control" tabindex="1" maxlength="20" size="20" name="planName" autocomplete="off" value="Standard" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input title="TXN_AMOUNT" class="form-control" tabindex="10" type="text" name="TXN_AMOUNT" value="299" readonly>
                            </div>
                        </div>
